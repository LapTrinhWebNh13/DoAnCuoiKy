				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="row">
							...
							<%
									ArrayList<Lop> dsLopMoi = new LopDAOImpl().getListLopMoi();
							%>
								<tr>
								    <th>Mã lớp</th>
								    <th>Địa chỉ</th>
							...
							<%
								for(Lop lopmoi : dsLopMoi)
								{
							%>
								  <tr>
								    <td><%=lopmoi.getMaLop() %></td>
								    <td><%=lopmoi.getDiaChi() %></td>
								    <td><%=lopmoi.getThoiGianDay() %></td>
								    <td><%=lopmoi.getHocLucHienTai() %></td>
								    <td><%=lopmoi.getLopDay() %></td>
								    <td><%=lopmoi.getMonDay() %></td>
								    <td><%=lopmoi.getLuong() %></td>
								    <td><a href="DangKyNhanLop.jsp?maLop=<%=lopmoi.getMaLop() %>"> <img src="image/icon-dang-ky.png"></a></td>
								  </tr>
							<%
								}
							%> 
