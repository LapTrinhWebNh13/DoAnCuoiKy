	  	...
	  	<div class="col-sm-8">
			  ...
			  <div id="menu">
				<ul class="nav navbar-nav" style="background-color:#F7CD20;">
				  ...
				  <li class="hover"><a href="PageServlet?command=TuyenDung&pageID=1" >TUYỂN DỤNG</a></li>
	  ...
	  <div class="row" id="main">
	  	...
	  	<div class="col-lg-7" style="">
	  		...
	  		<div class="panel panel-default">
				...
				<%-- <%
					ArrayList<TinTuc> dsTD = new TinTucDAOImpl().getTuyenDung();
					for(TinTuc tin : dsTD)
					{
				%>
					<tr>
						<td style="border-bottom: 2px solid #ddd;"><img src="./ImageTinTucServlet?maSo=<%=tin.getMaSo()  %>"></td>
						<td style="border-bottom: 2px solid #ddd;">
							<h5 style="margin-left: 10px;color: #FF8000;"><%=tin.getTieuDe() %></h5>
							<p style="margin-left: 10px;"><%=tin.getNoiDung() %>
						</td>
					</tr>
				<%
					}
				...
				<c:forEach items="${listTuyenDung}"  var="list"> 
					<tr>
						<td style="border-bottom: 2px solid #ddd;"><img src="././ImageServlet?command=TinTuc&maSo=${list.maSo }"></td>
						<td style="border-bottom: 2px solid #ddd;">
							<h5 style="margin-left: 10px;color: #FF8000;">${list.tieuDe }</h5>
							<p style="margin-left: 10px;">${list.noiDung }</p>
						</td>
					</tr>
				</c:forEach>
				</table>
				...
				<center>
					<ul class="pagination">
						<%
							...
							{
						%>
							<li><a href="PageServlet?command=TuyenDung&pageID=<%=i %>"><%=i %></a></li>
						<%
							}
						%>
					  </ul>
