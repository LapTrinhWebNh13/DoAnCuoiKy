		...
		<div class="row" id="main">
			...
			<div class="col-lg-7">
				<div class="panel panel-default">
					<div class="panel-heading"><p style="margin-left: 30px;color: white;font-weight: bold;font-size: 18px;">HỌC PHÍ GIA SƯ</p></div>
					<div class="panel-body">
													
							<h7><span style="color: #E46419"><u>Bảng giá học phí gia sư:</u></span></h7><br/><br/>
							
							<img src="image/bangGia.PNG" alt="anhtt" style="width: 630px;height: 400px;"><br/><br/>
							
							<h7><span style="color: #E46419"><u>Lưu ý :</u></span></h7><br/><br/>
							<p><i class="fa fa-asterisk"></i>Thời gian dạy của sinh viên một buổi là 120 phút, thời gian dạy của giáo viên một buổi là 90 phút. Học phí trên áp dụng cho 1 tháng từ thời điểm gia sư bắt đầu dạy học viên.</p><br>
					 		<p><i class="fa fa-asterisk"></i>Học phí sẽ tăng tùy theo số môn học(trừ trường hợp báo bài), số người học, địa điểm học và yêu cầu thêm (thêm 1 môn học là +100.000đ, thêm 1 người học là +200.000đ).</p><br>
					 		<p><i class="fa fa-asterisk"></i>Học phí trên áp dụng cho sinh viên và giáo viên có bằng cử nhân của các trường đại học khác hoặc giáo viên có bằng đại học sư phạm.</p><br>
					 		<p><i class="fa fa-asterisk"></i>Đối với thạc sỹ, giáo viên thâm niên, giáo viên dạy tại trường có kinh nghiệm dạy kèm mức học phí được tính theo tiết (1 tiết = 45 phút) :
</p>
					 		<p><i class="fa fa-space-shuttle"></i>Cấp 1:  70.000 đ -  90.000 đ / 1 tiết (45 phút) = 140.000 đ - 180.000 đ / 1 buổi .</p>
					 		<p><i class="fa fa-space-shuttle"></i> Cấp 2:  80.000 đ -  100.000 đ/ 1 tiết (45 phút) = 160.000 đ - 200.000 đ / 1 buổi .</p>
					 		<p><i class="fa fa-space-shuttle"></i>  Cấp 3: 100.000 đ- 120.000 đ / 1 tiết (45 phút) = 200.000 đ - 240.000 đ / 1 buổi.</p><br>
					 		
					 		<h7><span style="color: #E46419"><u>Khuyến cáo :</u></span></h7><br/>
					 		<p style="color: red;">Để thuê được gia sư tốt chất lượng tại bất kì trung tâm gia sư nào rất mong quý phụ huynh, học viên hãy kiểm tra trình độ, bằng cấp và chứng minh nhân dân của gia sư.</p><br>
