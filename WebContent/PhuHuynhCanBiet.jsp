				...
				<nav class="nav">
					<div id="menu">
						<ul class="nav navbar-nav" style="background-color:#F7CD20;">
							...
							<li class="hover"><a href="DangKyTimGiaSu.jsp" >PHỤ HUYNH</a></li>
		...
		<div class="row" id="main">
			...
			<div class="col-lg-7">
				<div class="panel panel-default">
					<div class="panel-heading"><p style="margin-left: 30px;color: white;font-weight: bold;font-size: 18px;">PHỤ HUYNH CẦN BIẾT</p></div>
					<div class="panel-body">
					 
							
							<h7> Bạn luôn mong con em mình giỏi giang, nhưng các em dường như đã rất vất vả với chuyện học ở trường?<br/></h7>
							<h7> Bạn nghĩ nên tìm cho con một gia sư tốt?<span style="color:#E46419"> Chúng tôi có một số lời khuyên dành cho bạn.</span></h7><br/><br/>
							<img src="image/gia-su-luyen-thi-dai-hoc.jpg" alt="anhtt" style="width: 620px;height: 300px;"><br/><br/>
							<h7><span style="color: #E46419"><u>Nên xác định rõ nhu cầu :</u></span></h7><br/><br/>
							<p><i class="fa fa-asterisk"></i>Vì sao bạn nghĩ rằng con mình cần học gia sư.</p>
					 		<p><i class="fa fa-asterisk"></i>Cháu có khó khăn trong việc học môn nào.</p>
					 		<p><i class="fa fa-asterisk"></i>Cháu vô cùng vất vả khi làm bài tập về nhà.</p>
					 		<p><i class="fa fa-asterisk"></i>Mối quan hệ giữa bạn và con có tốt không.</p>
					 		<p><i class="fa fa-asterisk"></i>Liệu con bạn không có vấn đề gì về phát triển trí tuệ.</p>
					 		<p><i class="fa fa-asterisk"></i>Một kỳ thi cực kỳ quan trọng tới gần.</p>
					 		
					 		<h7><span style="color: #E46419"><u>Nên trao đổi với giáo viên của con :</u></span></h7><br/><br/>
					 		...
					 		<p><i class="fa fa-asterisk"></i>Cháu đặc biệt yếu kém và cần được kèm cặp riêng môn nào?</p>
					 		<p><i class="fa fa-asterisk"></i>Hãy hỏi thầy cô về lịch thi, kiểm tra để Gia sư của con bạn có kế hoạch cụ thể cho việc ôn luyện, bồi dưỡng kiến thức.</p>
					 		<p><i class="fa fa-space-shuttle"></i><i class="fa fa-space-shuttle"></i><span style="color: #E46419;">Phẩm chất gia sư :</span> Nhìn chung, một gia sư tốt nhất là người phù hợp với cách học của con bạn. Có thể xem xét đến 2 yếu tố sau:</p>
					 		<p>1.Lịch học:</p>
					 		<p><i class="fa fa-asterisk"></i> Lịch học nào tốt nhất cho con?</p>
					 		<p><i class="fa fa-asterisk"></i> Mỗi buổi kéo dài bao lâu?</p>
					 		<p><i class="fa fa-asterisk"></i>  Con bạn sẽ học "một Thầy - một Trò" hay học nhóm?</p>
					 		<p><i class="fa fa-asterisk"></i>   Con bạn sẽ làm bài tập về nhà lúc nào? Trong bao lâu thì không quá tải?</p>
					 		<p>2.Phong cách học: Con bạn dễ tiếp thu bài vở qua cách học nào: Nghe giảng "Chay"? học với hình ảnh minh họa? học thông qua các hoạt động vui chơi? (Nếu bạn không nắm rõ, hãy hỏi thầy cô giáo của con).<br/>
   							Nếu việc học của con quả thực rất vất vả thì cách dạy truyền thống sẽ không mấy có tác dụng. Khi ấy bạn cần tìm một Gia sư sáng tạo hơn, người biết cách giúp con lĩnh hội kiến thức một cách hiệu quả nhất.</p>
   							<p><i class="fa fa-space-shuttle"></i><i class="fa fa-space-shuttle"></i><span style="color: #E46419;">Kế hoạch học tập  :</span> Khi đã tìm được Gia sư cho con, hãy ngồi lại cùng bàn kế hoạch giúp con tiến bộ. Ví dụ: Có thể hỏi Gia sư xem thầy cô ấy dự định tiến hành những bước cụ thể nào trong kế hoạch giúp con bạn? Mức độ tiến bộ của con sẽ được đánh giá bằng cách nào? Các buổi học sẽ đề cập đến kiến thức, các bài tập, bài kiểm tra trên lớp chứ?</p>
   							<p><i class="fa fa-space-shuttle"></i><i class="fa fa-space-shuttle"></i><span style="color: #E46419;">Hãy thực tế :</span> :Gia sư không phải là một ảo thuật gia tài thánh, quá trình học tập của con bạn cần thời gian mới thấy rõ sự tiến bộ. Bởi thế, hãy tỉnh táo trước những kỳ vọng, đừng quên cổ vũ con: "Mẹ biết con học vất vả, nhưng đây là kết quả của con tuần trước. Hãy xem, tuần này con tiến bộ"...</p>
							...
							<h7><span style="color: #E46419"><u>Liên hệ công ty tư vấn giáo dục-gia sư Thành Được :</u></span></h7><br/><br/>
							<p><i class="fa fa-hand-o-right"></i> Điện thoại: 0987.654.321 - 0971.747.722</p>
							<p><i class="fa fa-hand-o-right"></i>  Website: www.gstriviet.edu.vn - Email: GiaSuTriViet@gmail.com</p>
							<p><i class="fa fa-hand-o-right"></i> Tp.HCM: 63B Hồ Bá Phấn, P.Phước Long A, Quận 9, TPHCM, ĐT:(08)62.787.178</p>
							<p><i class="fa fa-hand-o-right"></i>Hà Nội: Số 4, Ngõ 3 Tô Hiệu, P.Nguyễn Trãi, Q.Hà Đông, Hà Nội, ĐT: (04)73.000.155</p>
							<p><i class="fa fa-hand-o-right"></i>  Đà Nẵng: 169 Lê Lợi, P.Hải Châu 1, Q.Hải Châu, Đà Nẵng, ĐT: (0236)7.301.886</p>
							<p><i class="fa fa-hand-o-right"></i> Cần Thơ: 51/1G Đường 3/2, P.Xuân Khánh, Q. Ninh Kiều, Cần Thơ, ĐT: (0710)7.302.044</p>
							<p><i class="fa fa-hand-o-right"></i> Bình Dương: 207/5A Phạm Ngũ Lão, Hiệp Thành, TDM, Bình Dương, ĐT: (0650)7.300.480</p>
							<p><i class="fa fa-hand-o-right"></i> Hải Phòng: 264 Đồng Hòa, Phường Đồng Hòa, Q.Kiến An, Hải Phòng, ĐT: (031)7.306.616</p>
							<p><i class="fa fa-hand-o-right"></i>  Đồng Nai: E10 Khu Phố 1, Phường Tân Hiệp, TP. Biên Hòa,  Đồng Nai, ĐT: (061)7.308.006</p>
							<p><i class="fa fa-hand-o-right"></i> Vũng Tàu: 207 Lê Hồng Phong, Phường 8, TP Vũng Tàu, Bà Rịa, ĐT: (064)7.303.030</p>
